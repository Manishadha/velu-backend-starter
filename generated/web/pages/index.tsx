    ...
    <main className="min-h-screen bg-slate-50 py-10 px-4 flex justify-center">
      <div className="w-full max-w-3xl bg-white rounded-2xl shadow-xl border border-slate-200 p-8">
        <p className="text-[0.7rem] uppercase tracking-[0.2em] text-slate-500 mb-2">
          oli_oli • web_app • Nextjs + Fastapi + Sqlite
        </p>
        <h1 className="text-2xl font-bold mb-1">
          oli_oli – Auto dev and e commerce,
        </h1>
        <p className="text-sm text-slate-600 mb-6">
          auto dev and e commerce,
        </p>

        <section className="mb-7">
          <h2 className="text-lg font-semibold mb-1">Core features</h2>
          <p className="text-sm text-slate-600 mb-1">
            These are the main things this <strong>oli_oli</strong> web_app should do:
          </p>
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-sm text-slate-900">
            ...
            <li>Add authentication / roles for customers", "internal team</li>
            <li>Iterate with Velu for the next version of this web_app</li>
          </ul>

          <p className="text-xs text-slate-500 mt-4">
            Design preference: simple and friendly"..
          </p>
        </section>
      </div>
    </main>
